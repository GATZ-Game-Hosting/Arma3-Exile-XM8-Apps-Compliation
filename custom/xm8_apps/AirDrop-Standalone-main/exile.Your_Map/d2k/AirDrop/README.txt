...
2)	Now you need to add this in two places:
		2.1)	d2k\AirdropFunctions\fn_refillbox.sqf  		--> This is where you define what is in the box
		2.2)	d2k\Airdrop\config.sqf			--> Here's where you add it to the airdrop menu


Adding Box Types to d2k\Airdrop\fn_refillbox.sqffn_refillbox.sqf
...
Adding Box Types to d2k\AirDrop\config.sqf
	...
	APOC_AA_FoodOptions =
	[
	//"Menu Text",		"Crate Type", 			Price, 		"drop type"
