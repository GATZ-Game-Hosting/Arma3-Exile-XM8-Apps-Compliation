...
private ["_DropType","_DropSelection","_player", "_DropDesc","_DropPrice","_DropType","_object","_playerMoney","_DropRespectThreshold","_playerRespect"]; //Variables coming from APOC_Airdrop_Assistance_XM8.sqf
...
if (APOC_AA_AdvancedBanking) then {
	...
	if (_DropRespectThreshold > _playerRespect) exitWith
	{
        ...
        _heli setDamage 1; //BOOM
        _object setDamage 1; //BOOM BOOM
		diag_log format ["Apoc's Airdrop Assistance - You don't have enough respect to request this airdrop!"];
	};
